...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    elif efficiency < 60 and efficiency >= 30: return "red"
    return "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if tn < threshold * 0.9: return "LOW"
    elif tn >= threshold - (threshold * 0.1) and tn <= threshold + (threshold * 0.1): return "NORMAL"
    return "DANGER"
