...
def value_of_ace(card_one, card_two):
    ...
    if card_one == 'A' or card_two == 'A':
        ...
        return 11 if value_of_card(card_one) + value_of_card(card_two) + 11 <= 21 else 1
...
def is_blackjack(card_one, card_two):
    ...
    """
    try:
        if value_of_card(higher_card(card_one, card_two)) == 10:
...
def can_split_pairs(card_one, card_two):
    ...
    """
    return type(higher_card(card_one, card_two)) is tuple
...
def can_double_down(card_one, card_two):
    ...
    return value >= 9 and value <= 11

print(is_blackjack('4', '7'))